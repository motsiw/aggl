...
function removeGender(sollrot) {
	...
	for (i = 0; i < result.length; i++) {
	  ...
	  str = str.replace(/(Die|Viele|Alle|Einige|Ihre| ihre| die| viele| alle| einige|kanische|kanischen)(| [0-9,.]*?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| vierzig| fünfzig| hundert| tausend) ([A-ZÜÖÄa-züöä])(rofessor|utor|rganisator|nvestor|ktionär|ovator|oderator)en([ ,).“\?"!\--])([^u]|$)/g,"$1$2 "+rot1+"$3$4:innen"+rot2+"$5$6");
	  ...
	  str = str.replace(/(Die|Viele|Alle|Einige|Ihre|Unsere|Seine| unsere| seine| ihre| die| viele| alle| einige|kanische|kanischen)(| [0-9,.]*?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| vierzig| fünfzig| hundert| tausend) ([A-ZÜÖÄ][a-züöäß]*?)(andwerker|portler|ünstler|orscher|orgänger|achfolger|egner|nhänger|esucher|nwender|chüler|rbeiter|ehrer|nhänger|rbeitnehmer|rbeitgeber|chmuggler|ichter|ertreter|ienstleister|pieler|issenschaftler|aucher|wohner|obachter|utzer|olitiker|ürger|inister|verdiener|usländer)([ ,).“\?"!\--])([^u]|$)/g,"$1$2 "+rot1+"$3$4:innen"+rot2+"$5$6");
