...
function removeGender(sollrot) {
	...
	for (i = 0; i < result.length; i++) {
	  ...
	  str = str.replace(/(Liebe|An|Durch|Bis|Für|Gegen|Ohne|Um|Alle|Rund|Knapp| liebe| an| durch| bis| für| gegen| ohne| um| alle| rund| knapp)(| [0-9,.]*?| [0-9,.]*? Millionen| [0-9,.]*? Mio\.| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| vierzig| fünfzig| hundert| tausend) ([A-ZÜÖÄ][a-züöäß]*?)(äger|ritiker|ropäer|ndianer|merikaner|andwerker|portler|ünstler|orscher|orgänger|achfolger|egner|nhänger|esucher|nwender|chüler|rbeiter|ehrer|nhänger|rbeitnehmer|rbeitgeber|chmuggler|ichter|ertreter|ienstleister|pieler|issenschaftler|aucher|wohner|eobachter|utzer|olitiker|ürger|inister|verdiener|usländer)([ ,).“\?"!\--])([^u]|$)/g,"$1$2 "+rot1+"$3$4:innen"+rot2+"$5$6");

	  // Nominativ/Akkusativ plural bei Nomen auf t
	  str = str.replace(/(Liebe|An|Durch|Bis|Für|Gegen|Ohne|Um|Alle|Rund|Knapp| liebe| an| durch| bis| für| gegen| ohne| um| alle| rund| knapp)(| [0-9,.]*?| [0-9,.]*? Millionen| [0-9,.]*? Mio\.| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| vierzig| fünfzig| hundert| tausend) ([A-ZÜÖÄa-züöäß])(ourist|siat|andrät|olizist|tudent|issident|andidat|äsident|oldat|xpert)en([ ,).“\?"!\--])([^u]|$)/g,"$1$2 "+rot1+"$3$4:innen"+rot2+"$5$6");
	  ...
	  str = str.replace(/(Von|Mit|Auf|Unter|Über|Vor|Zu|Aus|Bei|Außer|Nach|Samt|Seit|Meinen|Seinen|Laut|An| von| mit| auf| unter| über| vor| zu| aus| bei| außer| nach| samt| seit| meinen| seinen| unseren| ihren| laut| verschiedenen| vielen| an)(| [0-9,.]*?| [0-9,.]*? Millionen| [0-9,.]*? Mio\.| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| vierzig| fünfzig| hundert| tausend) ([A-ZÜÖÄ][a-züöäß]*?)(ourist|siat|andrät|olizist|tudent|issident|andidat|äsident|oldat|xpert)en([ ,).“\?"!\--])([^u]|$)/g,"$1$2 "+rot1+"$3$4:innen"+rot2+"$5$6");
	  ...
	  str = str.replace(/(Dieser|Vieler|Aller|Einiger|Ihrer| ihrer| dieser| vieler| aller| einiger|ischer)(| [0-9,.]*?| [0-9,.]*? Millionen| [0-9,.]*? Mio\.| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| vierzig| fünfzig| hundert| tausend) ([A-ZÜÖÄa-züöä])(ourist|siat|andrät|olizist|tudent|issident|andidat|äsident|oldat|xpert)en([ ,).“\?"!\--])([^u]|$)/g,"$1$2 "+rot1+"$3$4:innen"+rot2+"$5$6");
	  ...
	  str = str.replace(/(J|j)eder ([A-ZÜÖÄ][a-züöäß]*?)(äger|ritiker|ropäer|ndianer|merikaner|andwerker|portler|ünstler|orscher|orgänger|achfolger|egner|nhänger|esucher|nwender|chüler|rbeiter|ehrer|nhänger|rbeitnehmer|rbeitgeber|chmuggler|ichter|ertreter|ienstleister|pieler|issenschaftler|aucher|wohner|eobachter|utzer|ürger|olitiker|inister|verdiener|rofessor|utor|rganisator|nvestor|ktionär|ovator|oderator|usländer)([ ,).“\?"!\--])([^u]|$)/g,""+rot1+"$1ede:r $2$3:in$4"+rot2+"$5");

	  // Nominativ singular bei Nomen auf r und Unbestimmtheit "ein"
	  str = str.replace(/(Ein| ein) ([A-ZÜÖÄ][a-züöäß]*?)(äger|ritiker|ropäer|ndianer|merikaner|andwerker|portler|ünstler|orscher|orgänger|achfolger|egner|nhänger|esucher|nwender|chüler|rbeiter|ehrer|nhänger|rbeitnehmer|rbeitgeber|chmuggler|ichter|ertreter|ienstleister|pieler|issenschaftler|aucher|wohner|eobachter|utzer|ürger|olitiker|inister|verdiener|rofessor|utor|rganisator|nvestor|ktionär|ovator|oderator|usländer)([ ,).“\?"!\--])([^u]|$)/g,""+rot1+"$1:e $2$3:in$4"+rot2+"$5");

	  // Nominativ singular bei Nomen auf r und Unbestimmtheit "mancher"
	  str = str.replace(/(M|m)ancher ([A-ZÜÖÄ][a-züöäß]*?)(äger|ritiker|ropäer|ndianer|merikaner|andwerker|portler|ünstler|orscher|orgänger|achfolger|egner|nhänger|esucher|nwender|chüler|rbeiter|ehrer|nhänger|rbeitnehmer|rbeitgeber|chmuggler|ichter|ertreter|ienstleister|pieler|issenschaftler|aucher|wohner|eobachter|utzer|ürger|olitiker|inister|verdiener|rofessor|utor|rganisator|nvestor|ktionär|ovator|oderator|usländer)([ ,).“\?"!\--])([^u]|$)/g,""+rot1+"$1anche:r $2$3:in$4"+rot2+"$5");
